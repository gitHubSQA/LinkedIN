...
public class Test_PeopleYouMayKnowPage{
	...
	public void POS_Test_PeopleYouMayKnowPage() {
		//STEP 1: Click the Main Menu: My Networks
		pageMenu.clickMainMyNetworks(driver);
		//STEP 2: Click the Sub Menu: People You May Know
