// ---------------------------------------------------------------------------------------------------------------
// Test Description: Validates LinkedIn's Who Viewed Your Profile Page: Links, Title, Textboxes ...
...
public class pageWhoViewedProfile {
	
	//Constructor to initialize all the WebElements in THIS page.
	public pageWhoViewedProfile(WebDriver driver){
